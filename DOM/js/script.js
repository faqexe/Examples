...
img.scr = "https://picsum.photos/240";
...
div.appendChild(img);
// Изпользуя HTML строку, создать DIV с классом 'pDiv' + с 2-мя параграфами
const elemHTML = `
<div class='pDiv'>
   <p>Параграф 1</p>
   <p>Параграф 2</p>
...
// Поместить DIV с склассом autos на страницу DOM - до DIV с классом wrapper
